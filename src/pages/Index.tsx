...
const failureData = [
  ...
  { label: "Jest Snapshot", count: 28, percentage: 22, color: "orange" as const },
  { label: "NullPointer", count: 18, percentage: 15, color: "yellow" as const },
        ...
        <header className="flex items-center justify-between px-6 py-4 border-b border-border">
          <div className="flex items-center gap-4">
            <div className="text-sm text-muted-foreground">
              ...
              <span className="text-foreground font-medium">Backend-API-v2</span>
